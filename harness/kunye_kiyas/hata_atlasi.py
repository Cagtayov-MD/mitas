...
Salt-okunur: credit_onset.py / credit_content.py / credit_box.py / olc_pool.py
...
import credit_onset as co        # noqa: E402  (salt-okunur kullanım)
...
def main() -> int:
    ...
    baslik = ("# Hata Atlası — 31 hatanın kanıt-bazlı teşhisi (Görev 3 / T3)\n\n"
              ...
              "Salt-okunur girdi: `tespit_v5` (credit_onset.py) değiştirilmedi. "
