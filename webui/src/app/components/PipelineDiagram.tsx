...
const NODE_DETAILS: Record<string, string[]> = {
  ...
  credit:  ['qwen3.6:35b (Ayıklayıcı): OCR metninden yönetmen/yapımcı/cast', 'QC1 kapısı: yönetmen BOŞ veya cast<3 → RED', 'QC1-RED: gemma4 VL ile pikselden oku (--fill-cast)', 'QC1 tekrar: hâlâ RED → _qc1_failed → KONTROL', 'OCR-OTORİTE: her isim OCR metninde olmalı'],
