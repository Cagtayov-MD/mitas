#!/usr/bin/env bash
# Lebron kulesinin calisma zamanini SIFIRDAN kurar (spec 2 — kule kendi calisma zamanini tasir).
#
...
# Lebron cv2'yi DOGRUDAN import ediyor (derleyici); opencv yalniz paddleocr/
