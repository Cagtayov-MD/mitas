...
`kanit.tespit_bas_kare`'de yaşar). `bitis_kare` 2026-08-17 (akşam)'dan beri
BİTİŞ ŞELALESİ'nden gelir (`kanit.bitis_kaynagi`: ters-motor | kural |
sinir; ham sinir bitişi `kanit.bitis_sinir_ham`'de). KOBRA'da şelale kuralı
kazandı: 41 → 449 (GT 242; KOBRA izci-sınıfı bir film — bkz.
`olcum/giris/bitis_kalibrasyonu.md`). Güven 0.754.
