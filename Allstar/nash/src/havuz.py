"""NASH havuz çekirdeği (framehavuz / Havuz v2) — kare seçici.

TAŞIMA NOTU (2026-08-14): bu dosya harness/track_kunye/steve_nash.py'nin
BİREBİR kopyasıdır; yalnız bu docstring başlığı değişti. Algoritma DEĞİŞMEZ —
sadeleştirme, "iyileştirme", yeniden yazım YASAK. Taşıma kapısı (olcum/kapi1.py)
15 filmde havuz istatistiğinin bit düzeyinde aynı kaldığını ölçer; burada tek
satır oynatmak o kapıyı geçersiz kılar. Gerekçe: spec §7.1.

Ön temizlik ve kare seçici pipeline.
