"""Havuz cekirdegi birim testleri — sentetik dizilerle.

Kaynak: harness/track_kunye/test_messi.py — birebir tasindi (import adi haric).
Bu testler havuz.py'nin DAVRANISINI dondurur; spec 7.1: algoritma degismez.
Kosum: Allstar/nash/venv/bin/python -m pytest tests -q
"""
import cv2
import numpy as np
import pytest
